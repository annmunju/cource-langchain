...
def lookup(name: str) -> str:
    ...
    tools_for_agent = [Tool(name="Crawl Google 4 linkedin profile page", func=get_profile_url,  # 의무
    ...
    agent = initialize_agent(tools=tools_for_agent, 
                             ...
                             verbose=True)    
    prompt_templete = PromptTemplate(template=template, input_variables=["name_of_person"])
